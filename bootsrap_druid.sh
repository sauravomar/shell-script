...
#===============================================================================
#
#          FILE: bootsrap_druid.sh
# 
#         USAGE: ./bootsrap_druid.sh 
# 
#   DESCRIPTION: 
# 
#       OPTIONS: ---
...
#        AUTHOR: YOUR NAME (), 
#  ORGANIZATION: 
#       CREATED: Tuesday 30 May 2017 11:20:34  IST
#      REVISION:  ---
#===============================================================================
...
cd /home/saurav/Downloads/druid-0.10.0
...
java `cat conf-quickstart/druid/overlord/jvm.config | xargs` -cp "conf-quickstart/druid/_common:conf-quickstart/druid/overlord:lib/*" io.druid.cli.Main server overlord > log/overlord.log &
